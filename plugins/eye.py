...
def replx(app,message):
    ...
    if int(message.left_chat_members[-1].id) == int(6300938349):
...
def repl(app,message):
    ...
    if int(message.new_chat_members[-1].id) == int(6300938349):
        try:
            m = app.get_chat_member(chat_id=message.chat.id,user_id=6300938349)
